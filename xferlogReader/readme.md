This utility are build in python to read and register in some of these relational database MySQL or PostgreSQL the data about file transfer on Proftpd Server.
